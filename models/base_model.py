...
"""
This module contains the class BaseModel. Description of th class can be found in the class's docstring
"""
...
class BaseModel:
    ...
    def to_dict(self):
        ...
        dict_repr.update([("__class__", self.__class__.__name__), ("created_at", self.created_at.isoformat()),
